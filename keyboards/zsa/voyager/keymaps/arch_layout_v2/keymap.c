...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_EXTEND] = LAYOUT(
        ...
        MS_WHLL, _______, _______, _______, _______, KC_Y,                         _______, _______, _______, _______, _______, _______,
        MS_WHLR, _______, _______, _______, _______, KC_H,                         _______, _______, _______, _______, _______, _______,
